...
from sklearn.metrics import accuracy_score, precision_score, precision_recall_fscore_support, f1_score, recall_score, confusion_matrix
...
class kNN:
    def __init__(self):
        ...
        self.knn = KNeighborsClassifier(n_neighbors=len(get_classes()))
    ...
    def apply(self, data):
        predicted = self.knn.predict(data)
        return predicted
...
#    print('Toчност:', accuracy_score(test_labels, test_predictions))
#    print('Прецизност micro: ', precision_score(test_labels, test_predictions, average='micro'))
#    print('Прецизност macro: ', precision_score(test_labels, test_predictions, average='macro'))
#    
#    print('Обхват macro: ', recall_score(test_labels, test_predictions,  average='macro'))
#
#    print('F-оценка micro: ', f1_score(test_labels, test_predictions, average='micro'))
#    print('F-оценка macro: ', f1_score(test_labels, test_predictions, average='macro'))